...
public class ChequeBookRequestObj {
   ...
   private WebElement chequeBookRequest_NumberOfChequeBook;
	...
	@FindBy(xpath="//*[@id='chequeBookChargesDiv_Q000MT']/div[2]/span[1]")
	...
	@FindBy(id="chequeBook_toCancel_Q000TC")
	...
	@FindBy(xpath="//a[@menuvar='Q000TC']//parent::td//following-sibling::td/span")
	...
	@FindBy(xpath="//a[@menuvar='Q000AC']//parent::td//following-sibling::td/span")
	...
	@FindBy(xpath="//a[@menuvar='O001UP']//parent::td//following-sibling::td/span")
