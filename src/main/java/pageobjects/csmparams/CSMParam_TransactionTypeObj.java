...
public class CSMParam_TransactionTypeObj {
	...
	@FindBy(xpath = "//input[contains(@id,'ALLOW_ALERTS_TO_OFFLINE_USERS') and @class='editable']")
	private WebElement transactionType_AllowAlertsToOfflineUsersFlag;

	public WebElement transactionTypeAllowAlertsToOfflineUsersFlag() {
		return transactionType_AllowAlertsToOfflineUsersFlag;
	}

	@FindBy(xpath = "//input[contains(@id,'ctstrxtypeChargesVO.CHARGE_CODE_lookuptxt_tab26_GridTbl_Id_P024MA')]")
	private WebElement cifTypeChargesChargeCodeInput;

	public WebElement cifTypeChargesChargeCodeInput() {
		return cifTypeChargesChargeCodeInput;
	}

	@FindBy(xpath = "//select[contains(@id,'_ctstrxtypeChargesVO.CASH_ACCOUNT')]")
	private WebElement cifTypeChargesChargeCashAccountDropdown;

	public WebElement cifTypeChargesChargeCashAccountDropdown() {
		return cifTypeChargesChargeCashAccountDropdown;
	}

	@FindBy(id = "ok_btn_20_P024MA")
	private WebElement cifTypeChargesChargeOkButton;

	public WebElement cifTypeChargesChargeOkButton() {
		return cifTypeChargesChargeOkButton;
	}

	@FindBy(xpath = "//select[contains(@id,'_ctstrxtypeChargesVO.ACTION_TYPE')]")
	private WebElement cifTypeChargesChargeActionTypeDropdown;

	public WebElement cifTypeChargesChargeActionTypeDropdown() {
		return cifTypeChargesChargeActionTypeDropdown;
	}

	@FindBy(id = "cifTypeCharges_btn_P024MA")
	private WebElement cifTypeChargesButton;

	public WebElement cifTypeChargesButton() {
		return cifTypeChargesButton;
	}

	@FindBy(xpath = "//td[@id='tab26_GridTbl_Id_P024MA_pager_left']//span[@class='ui-icon ui-icon-plus']")
	private WebElement cifTypeChargesCIFTypeAddButton;

	public WebElement cifTypeChargesCIFTypeAddButton() {
		return cifTypeChargesCIFTypeAddButton;
	}

	@FindBy(xpath = "//select[contains(@id,'ctstrxtypeChargesVO.CHARGES_CY_POLICY')]")
	private WebElement cifTypeChargesChargeCYPolicyDropdown;

	public WebElement cifTypeChargesChargeCYPolicyDropdown() {
		return cifTypeChargesChargeCYPolicyDropdown;
	}

	@FindBy(xpath = "//input[contains(@id,'ctstrxtypeChargesVO.ENTITY_CODE_lookuptxt_tab26_GridTbl_Id_P024MA')]")
	private WebElement cifTypeChargesCIFTypeInput;

	public WebElement cifTypeChargesCIFTypeInput() {
		return cifTypeChargesCIFTypeInput;
	}
